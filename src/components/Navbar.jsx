  ...
  return (
    ...
    items-center p-4'>
      <div className='flex items-center'>
       ...
       <h1 className='text-2xl sb:text-3xl lg:text-4xl px-2'>
       ...
       rounded-full p-1 text-[14px]'>
          ...
          px-2 w-[200px] sb:w-[400px] lg:[500px]'>
         ...
         <div className={nav
            ...
            size={30} className='absolute right-4 top-4 cursore-ponter'/>
            <h2 className='text-2xl p-4'>Best<span
            className='font-bold'>Eats</span>
            </h2>
             <nav>
